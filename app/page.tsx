...
export default function Home() {
  ...
  const storyRefs = useRef<(HTMLElement | null)[]>(new Array(12).fill(null));
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 relative">
      ...
      <div className="max-w-5xl mx-auto px-6 py-24 space-y-40 relative">
        ...
        <section ref={el => { storyRefs.current[11] = el; }} className="relative">
          <div className="absolute -left-4 top-0 w-1 h-full bg-gradient-to-b from-slate-300 via-slate-400 to-transparent opacity-50"></div>
          <p className="story-paragraph text-lg md:text-xl text-slate-600 leading-relaxed font-light pl-8 text-smooth italic">
            <strong>Note:</strong> The real person behind this story is still going through her health journey. To respect her privacy and ongoing experience, I have chosen not to include her real name or specific details. This story represents the experiences of countless women facing similar challenges in healthcare systems that often fail to see and understand their pain.
          </p>
        </section>
